...
const person = new Person({
  name: "Fais Nasrullah",
  age: 25,
  favoriteFoods: ["Bakso", "Ayam Goreng", "Jengkol"]
});
...
const arrayOfPeople = [
  {
    name: "Salsabila Alif",
    age: 24,
    favoriteFoods: ["Mie Ayam", "Nasi Goreng"]
  },
  {
    name: "Arman Maulana",
    age: 24,
    favoriteFoods: ["Ayam Goreng", "Nasi Goreng"]
  },
  {
    name: "Nurul Ghina Qonita",
    age: 23,
    favoriteFoods: ["Ketoprak"]
  }
];
